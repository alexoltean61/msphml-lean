...
/-
Subsort operators not implemented yet.
But BTW they probably also require some specific axioms
...
notation:100 "set" "(" mem ", "  x ", "  n ")" => ℋ⟨SMC.setMem_Var_Nat_Mem⟩ (mem, x, n)
notation:102 "++" x:101 => ℋ⟨SMC.«++Var_AExp»⟩ x
notation:102 a1:99 "+" a2:100 => ℋ⟨SMC.«_+_AExp_AExp_AExp»⟩ (a1, a2)
notation:100 a1:99 "<=" a2:100 => ℋ⟨Leq⟩ (a1, a2)

notation:100 "plus" => SMC.plus

notation:100 "leq" => SMC.leq

notation:100 "skip" => SMC.skip
